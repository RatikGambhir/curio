...
export function VerificationCodeForm({
  ...
  return (
    <Card className="animate-in fade-in-0 zoom-in-95 duration-500 w-full max-w-xl rounded-2xl border-border/80 shadow-lg">
      <CardHeader className="space-y-2 text-center">
        <CardTitle className="text-2xl">Verify your email</CardTitle>
        <p className="text-sm text-muted-foreground">Enter the 6-digit code sent to {email}.</p>
        <p className="text-sm font-medium text-foreground">Code expires in {timeDisplay}</p>
      </CardHeader>
      <CardContent>
