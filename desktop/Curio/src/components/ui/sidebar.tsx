...
function Sidebar({
  ...
  return (
    <div
      className="group peer hidden p-0 text-sidebar-foreground md:flex"
      data-state={state}
...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        "fixed inset-y-0 right-0 left-(--sidebar-width) z-10 hidden h-svh flex-1 p-0 transition-[left,right,width] duration-200 ease-linear peer-data-[collapsible=icon]:left-(--sidebar-width-icon) peer-data-[side=right]:left-0 peer-data-[side=right]:right-(--sidebar-width) peer-data-[side=right]:peer-data-[collapsible=icon]:right-(--sidebar-width-icon) md:flex",
        className,
      )}
      {...props}
    />
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "text-sidebar-foreground ring-sidebar-ring absolute top-1.5 right-1 flex aspect-square w-5 items-center justify-center rounded-md p-0 outline-hidden transition-transform hover:-translate-y-0.5 focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0 after:absolute after:-inset-2 md:after:hidden peer-data-[size=sm]/menu-button:top-1 peer-data-[size=default]/menu-button:top-1.5 peer-data-[size=lg]/menu-button:top-2.5 group-data-[collapsible=icon]:hidden",
        showOnHover &&
